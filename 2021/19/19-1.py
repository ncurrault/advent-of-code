...
result = set() # should contain all beacons, in coordinates of scanner 0
...
while len(scanners_remaining) > 0:
    ...
    for scanner_to_connect in scanners_remaining:
        for scanner_group in overlap_groups_by_scanner[scanner_to_connect].keys():
            ...
            for scanner_beacon in beacons_by_scanner[scanner_to_connect]:
                result.add(xform_to_base(scanner_beacon))
